...
export default function SupportLayout({ children }: { children: ReactNode }) {
  const routes = [
    ...
    { page: "Open", link: "/support/tickets?status=open", icon: <TicketIcon className="size-5 text-blue-600" /> },
    {
      page: "Waiting",
      link: "/support/tickets?status=waiting",
      icon: <TicketIcon className="size-5 text-orange-600" />,
    },
    { page: "Solved", link: "/support/tickets?status=solved", icon: <TicketIcon className="size-5 text-green-600" /> },
  ];
